...
var PushGuarantee = /** @class */ (function () {
    ...
    PushGuarantee.prototype.transact = function (trx, trxOptions) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._transact(trx, trxOptions, trxOptions.pushRetries || this.pushOptions.pushRetries || 3)];
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        backoff *= trxOptions.backoff_exponent || this.pushOptions.backoff_exponent || 1.5;
                        if (!readRetries--)
